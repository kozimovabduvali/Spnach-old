                    ...
                    <Col xs={12}>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 lg:gap-20 text-center lg:text-start">
                            <div className="">
                                ...
                                <img src={img2} className='pointer-events-none mt-8 lg:mt-[65px] relative xl:-left-[195px] xl:max-w-[800px] 2xl:max-w-[927px] animiupdown' alt="Img" loading='lazy' />
                            </div>
                            <div className="">
                                ...
                                <img src={img} className='pointer-events-none' alt="Img" loading='lazy' />
                            </div>
                        </div>
                    </Col>
                </Row>
            </Container>
            <img src={shape1} className='pointer-events-none absolute bottom-0 left-0 w-full max-h-[174px]' alt="Img" loading='lazy' />
            <img src={shape2} className='pointer-events-none  -z-1 absolute top-1/2 left-1/2 -translate-1/2' alt="Img" loading='lazy' />
        </div>
    )
}
