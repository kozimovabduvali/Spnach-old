...
export default function What() {
    ...
    return (
        <div className='what-area'>
            <img src={shape} className='w-full h-30 md:h-40 xl:h-62.5' alt="" />
            <div className='What bg-[#6EE1F4] relative z-10 pt-15 md:pt-20 2xl:pt-32' id='what'>
                ...
                <img src={c_img} className='hidden md:block absolute top-[20%] left-0 -z-10 max-w-[30%]' alt="" />
                <img src={d_img} className='hidden md:block absolute top-[20%] right-10 -z-10 max-w-[30%]' alt="" />
                <div className='bg-[#9FD99A] py-13.5 relative z-1'>
                    <img src={a_img} className='hidden md:block absolute -top-[48%] xl:-top-[58%] 2xl:-top-[64%] left-0 -z-10' alt="" />
                    <img src={b_img} className='hidden md:block absolute -top-[48%] xl:-top-[58%] 2xl:-top-[64%] right-0 -z-10' alt="" />
                    <Container>
                        <Row>
                            <Col xs={12}>
