...
export default function Banner() {
  return (
    <div className='banner relative z-10 w-full md:h-screen flex items-center'>
      <img className='absolute top-0 left-0 w-full h-full -z-1 object-cover' src={bg} alt="Img" />
      <img className='absolute top-[25%] xl:top-[20%] left-0 md:left-[1%] xl:left-[5%] max-w-20 md:max-w-25 xl:max-w-30 rotateanimi -z-1' src={star1} alt="Img"/>
      <img className='absolute top-[20%] right-0 md:right-[1%] xl:right-[5%]  max-w-15 md:max-w-25 xl:max-w-40 -z-1 rotateanimi4' src={star4} alt="Img" />
      <Container className='h-full'>
        <div className='relative md:absolute top-25 md:top-28 lg:top-35 left-1/2 -translate-x-1/2'>
          <div className='justify-center flex relative w-max mx-auto z-1'>
            <img className='absolute -top-10 md:top-0 -left-10 -z-1 md:left-[-165px]  max-w-15 lg:max-w-20 xl:max-w-35 rotateanimi2' src={star2} alt="Img" />
            <img className='absolute -top-10 md:top-0 -right-10 md:right-[-155px]  max-w-15 lg:max-w-20 xl:max-w-30 -z-1 rotateanimi3' src={star3} alt="Img" />
        ...
        <Row className='items-center md:h-full'>
          <Col xs={12} md={7} className='h-full flex items-center'>
            <div className="banner-content text-center md:text-start relative z-5 mt-28 md:mt-0">
              <img className='w-full max-w-60 mx-auto md:ms-0 md:max-w-80 xl:max-w-100 4xl:max-w-150 mb-4 ' src={LogoSpanch} alt="Img" />
          ...
          <Col xs={12} md={5} className='flex items-end justify-center'>
            <div className="banner-right relative z-1">
              <div className="w-full max-w-50 md:max-w-120 lg:max-w-160 xl:max-w-193 z-2 md:mt-60">
                <img className='' src={bannervideo} alt="Img" />
                {/* <div className="">
                  <ReactPlayer
                    src={bannervideo2}
                    playing
      ...
      <img className='absolute -bottom-40 left-0 w-full h-80 object-cover xl:object-fill' src={bannershap} alt="Img" />
    </div>
  )
}
