  ...
  return (
    <div className='about bg-[#6EE1F4] relative z-2 '>
        ...
        <Row>
          ...
          <Col xl={5}>
            <div className="image w-full px-10 lg:px-0 hidden 3xl:block">
              <img src={video} className="xl:absolute -right-20 bottom-0 w-full max-w-100 mx-auto  xl:max-w-150  3xl:max-w-175" alt="" />
            </div>
          </Col>
        </Row>
      </Container>
      ...
      <div className="image w-full px-10 lg:px-0 3xl:hidden">
        <img src={video} className="xl:absolute right-0 bottom-0 w-full max-w-100 mx-auto  xl:max-w-150  3xl:max-w-180" alt="" />
      </div>
      <img src={shape_3} className='absolute right-0 bottom-0 -z-1 md:w-[48%] lg:w-[44%] 2xl:w-[40%] object-contain' alt="" />
