                ...
                <Row>
                    <Col xs={12}>
                        ...
                        <div className="flex flex-col gap-5 lg:gap-0 items-center lg:items-start mt-15 3xl:-mt-35 relative z-1 max-w-[1532px] pb-[200px] md:pb-[240px]">
                            ...
                            <img src={img1} className='max-w-[120px] md:max-w-[200px] lg:max-w-max absolute bottom-0 left-0 3xl:-left-34 z-1' alt="" />
                            <img src={img2} className='max-w-[120px] md:max-w-[200px] lg:max-w-max absolute bottom-0 right-0 3xl:-right-24  z-1' alt="" />
                        </div>
                    </Col>
                </Row>
            </Container>
            <img src={bg} className='absolute top-0 left-0 w-full -z-1' alt="" />
        </div >
    )
}
