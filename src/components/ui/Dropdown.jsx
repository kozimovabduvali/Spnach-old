            ...
            {defaultItem.icon &&
              <span className='size-5.5 rounded-full overflow-hidden'>
                {defaultItem.code ?
                  ...
                  :
                  <img src={defaultItem.icon} className=' w-full h-full object-cover' alt="Img" loading='lazy' />
                }
              </span>
            }
                ...
                {item.icon &&
                  <span className='size-5.5 rounded-full overflow-hidden'>
                    {item.code ?
                      ...
                      :
                      <img src={item.icon} className=' w-full h-full object-cover' alt="Img" loading='lazy' />
                    }
                  </span>
                }
